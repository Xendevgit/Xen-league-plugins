...
@ConfigGroup("LXenSandConfig")
public interface LXenSandConfig extends Config {
	...
	default String instructions() {
		return "Teleports to Yanille sandpit with last recall, and uses portable waystone to bank. Make sure you have the right fragments equipped, the waystone unlocked";
	}
