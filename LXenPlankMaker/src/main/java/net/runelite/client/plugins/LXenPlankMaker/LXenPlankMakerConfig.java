...
@ConfigGroup("LXenPlankMakerConfig")
public interface LXenPlankMakerConfig extends Config {
	...
	@ConfigItem(
			keyName = "stopAtCoins",
			name = "Stop at coins",
			description = "what number of coins to stop at",
			position = 17
	)
	default int stopAtCoins() {
		return 100000;
	}
